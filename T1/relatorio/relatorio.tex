...
\begin{document}
    ...
    Por fim, temos o gráfico na \autoref{fig:graficos_disc}. Vemos o comportamento esperado pela análise feita anteriormente. O gráfico de barras mostra muitas observações para 4 cilindros e uma cauda à direita. O boxplot mostra que a maioria das observações estão no intervalo interquartílico e o peculiar comportamento de $Q_1 = Q_2$ é visto com a mediana sendo o limite inferior da caixa.
